...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/inputdeviceserver: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/inputdeviceserver ${OBJECTFILES} ${LDLIBSOPTIONS} -lwiringPi -lpthread

${OBJECTDIR}/Application.o: Application.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../libraries/wiringPi/wiringPi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Application.o Application.cpp

${OBJECTDIR}/DriverGPIO/gpio.o: DriverGPIO/gpio.c 
	${MKDIR} -p ${OBJECTDIR}/DriverGPIO
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DriverGPIO/gpio.o DriverGPIO/gpio.c

${OBJECTDIR}/DriverI2C/i2c.o: DriverI2C/i2c.c 
	${MKDIR} -p ${OBJECTDIR}/DriverI2C
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DriverI2C/i2c.o DriverI2C/i2c.c

${OBJECTDIR}/DriverLcdST7735R/DriverLcdST7735R.o: DriverLcdST7735R/DriverLcdST7735R.cpp 
	${MKDIR} -p ${OBJECTDIR}/DriverLcdST7735R
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../libraries/wiringPi/wiringPi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DriverLcdST7735R/DriverLcdST7735R.o DriverLcdST7735R/DriverLcdST7735R.cpp

${OBJECTDIR}/DriverLcdST7735R/DriverLcdST7735RText.o: DriverLcdST7735R/DriverLcdST7735RText.cpp 
	${MKDIR} -p ${OBJECTDIR}/DriverLcdST7735R
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../libraries/wiringPi/wiringPi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DriverLcdST7735R/DriverLcdST7735RText.o DriverLcdST7735R/DriverLcdST7735RText.cpp
...
${OBJECTDIR}/DriverOledSSD1306/DriverOledSSD1306.o: DriverOledSSD1306/DriverOledSSD1306.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../libraries/wiringPi/wiringPi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DriverOledSSD1306/DriverOledSSD1306.o DriverOledSSD1306/DriverOledSSD1306.cpp

${OBJECTDIR}/DriverOledSSD1306/DriverOledSSD1306Text.o: DriverOledSSD1306/DriverOledSSD1306Text.cpp 
	${MKDIR} -p ${OBJECTDIR}/DriverOledSSD1306
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../libraries/wiringPi/wiringPi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DriverOledSSD1306/DriverOledSSD1306Text.o DriverOledSSD1306/DriverOledSSD1306Text.cpp

${OBJECTDIR}/DriverSpi/spi.o: DriverSpi/spi.c 
	${MKDIR} -p ${OBJECTDIR}/DriverSpi
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DriverSpi/spi.o DriverSpi/spi.c

${OBJECTDIR}/InputDevices/InputDevices.o: InputDevices/InputDevices.cpp 
	${MKDIR} -p ${OBJECTDIR}/InputDevices
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../libraries/wiringPi/wiringPi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/InputDevices/InputDevices.o InputDevices/InputDevices.cpp

${OBJECTDIR}/OutputTest.o: OutputTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../libraries/wiringPi/wiringPi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OutputTest.o OutputTest.cpp

${OBJECTDIR}/PythonWrapper.o: PythonWrapper.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../libraries/wiringPi/wiringPi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PythonWrapper.o PythonWrapper.cpp

${OBJECTDIR}/font/font.o: font/font.c 
	${MKDIR} -p ${OBJECTDIR}/font
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/font/font.o font/font.c

${OBJECTDIR}/main.o: main.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../libraries/wiringPi/wiringPi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp
